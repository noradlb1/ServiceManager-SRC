...
Public Class Form1
    ...
    Private Sub lvServices_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        UpdateUIForSelectedService()
    End Sub
    ...
    Private Sub EnumServices()
        ...
        Try
            ...
            For Each controller As ServiceController In services
                Dim itm As ListViewItem = lvServices.Items.Add(controller.ServiceName.ToString)
                With itm
                    itm.ImageIndex = 0
                    .SubItems.Add(controller.DisplayName)
                    .SubItems.Add(controller.Status.ToString())
                    .SubItems.Add(controller.ServiceType.ToString())
                    .SubItems.Add(controller.CanStop.ToString)
                End With
